  ...
  <main>
    <div class="bevel-corners">
      ...
      <div>
        ...
        magna aliqua. Dignissim diam quis enim lobortis scelerisque fermentum dui faucibus in.
      </div>
    </div>
    <div class="bevel-corners">
      <p>② radial-gradient</p>
      <div>
        Etiam dignissim diam quis enim lobortis scelerisque fermentum dui faucibus. Neque egestas congue quisque
    ...
    <div class="bevel-corners">
      <p>③ Inline SVG</p>
      <div>
        Cras semper auctor neque vitae tempus quam pellentesque nec. Congue quisque egestas diam in arcu. Purus in
    ...
    <div class="bevel-corners">
      <p>④ clip-path</p>
      <div>
        Molestie ac feugiat sed lectus vestibulum. Eu turpis egestas pretium aenean pharetra magna ac. Porttitor eget
